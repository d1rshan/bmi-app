        ...
        children: <Widget>[
          ...
          GestureDetector(
            onPanUpdate: (details) {
              ...
              if (_offset.dy < _NewPageState._minHeight) {
                _offset = Offset(0, _NewPageState._minHeight);
                _isOpen = false;
              } else if (_offset.dy > _NewPageState._maxHeight) {
                _offset = Offset(0, _NewPageState._maxHeight);
                _isOpen = true;
              }
              setState(() {});
            },
          ...
          Positioned(
            bottom: 2 * _NewPageState._minHeight -
                _offset.dy -
